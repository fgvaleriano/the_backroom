...
public class GameDetailsForm extends BaseMediaForm{
    ...
    public void populateForm(ResultSet rs, String game_dev, String game_studio, String publisher,
                             String category, String game_mode, String platform, String links) {
        try {
            ...
            gamePublisherField.setValues(publisher);
