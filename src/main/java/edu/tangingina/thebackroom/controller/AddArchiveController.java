...
public class AddArchiveController implements Initializable {
    ...
    public void mainInitialize(){
        root.getStylesheets().add(getClass().getResource("/edu/tangingina/thebackroom/Button_Style.css").toExternalForm());
        typeMenu.getItems().addAll("Movie", "TV Shows", "Books", "Games");
        typeMenu.getStylesheets().add(getClass().getResource("/edu/tangingina/thebackroom/MediaType_ComboBox.css").toExternalForm());

        //there is still an issue  with the synopField, dont knwo what to do with it yet...
        synopField.getStylesheets().add(getClass().getResource("/edu/tangingina/thebackroom/AddArchive_TextArea.css").toExternalForm());
    ...
    public void bookInitialize(){
        ...
        authorMenu.getStylesheets().add(getClass().getResource("/edu/tangingina/thebackroom/MediaType_ComboBox.css").toExternalForm());
        addListenerAuthorMenu();
        addAuthorScrollPane.getStylesheets().add(getClass().getResource("/edu/tangingina/thebackroom/AddAuthor.css").toExternalForm());
        ...
        publisherMenu.getStylesheets().add(getClass().getResource("/edu/tangingina/thebackroom/MediaType_ComboBox.css").toExternalForm());
        addListenerPublisherMenu();
        addPublisherScrollPane.getStylesheets().add(getClass().getResource("/edu/tangingina/thebackroom/AddAuthor.css").toExternalForm());
    ...
    public void gameInitialize(){
        ...
        gameEngineMenu.getStylesheets().add(getClass().getResource("/edu/tangingina/thebackroom/MediaType_ComboBox.css").toExternalForm());
        systemRequire.getStylesheets().add(getClass().getResource("/edu/tangingina/thebackroom/AddArchive_TextArea.css").toExternalForm());

        setGameDevMenu();
        addListenerGameDevMenu();
        gameDeveloperMenu.setItems(gameDevFilter);
        gameDeveloperMenu.getStylesheets().add(getClass().getResource("/edu/tangingina/thebackroom/MediaType_ComboBox.css").toExternalForm());
        addGameDevScrollPane.getStylesheets().add(getClass().getResource("/edu/tangingina/thebackroom/AddAuthor.css").toExternalForm());
        ...
        gameModeMenu.getStylesheets().add(getClass().getResource("/edu/tangingina/thebackroom/MediaType_ComboBox.css").toExternalForm());
        addGameModeScrollPane.getStylesheets().add(getClass().getResource("/edu/tangingina/thebackroom/AddAuthor.css").toExternalForm());
        ...
        gamePlatformMenu.getStylesheets().add(getClass().getResource("/edu/tangingina/thebackroom/MediaType_ComboBox.css").toExternalForm());
        addPlatformScrollPane.getStylesheets().add(getClass().getResource("/edu/tangingina/thebackroom/AddAuthor.css").toExternalForm());
